...
fasttext_model = fasttext.load_model('F:/SceneText-Detection/SceneText-Reg/SEED/data/pretrained_model/cc.vi.300.bin')
...
def createDataset(outputPath, imagePathList, labelList, lexiconList=None, checkValid=True):
  ...
  env = lmdb.open(outputPath, map_size=int(1e+11))
  cache = {}
  cnt = 1
...
if __name__ == "__main__":
  ...
  """
  data_dir = 'F:/SceneText-Detection/SceneText-Reg/SEED/content/cropped_imgs'
  lmdb_output_path = 'F:/SceneText-Detection/SceneText-Reg/SEED/content/lmdb/test'
  gt_file = os.path.join(data_dir, 'gt_test.txt')
  #gt_file = 'content/cropped_imgs/gt.txt'
  ...
  for i, line in enumerate(lines):
      ...
      imagePathList.append(os.path.join(data_dir, image_name.split('/')[-1]))
