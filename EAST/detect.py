...
from predict import predict_text_by_img
...
if __name__ == '__main__':
	img_path    = '../vietnamese/test_imgs/im1502.jpg'
	model_path  = './pths/model_epoch_14.pth'
	# img_path    = '/content/drive/MyDrive/Colab Notebooks/Dataset/vietnamese/test_image/im1500.jpg'
	# model_path  = '/content/drive/MyDrive/Colab Notebooks/Trained Models/pretrained_east/east_vgg16.pth'
	res_img     = './res.bmp'
	...
	# img2 = Image.open('./1500_im1500_7.jpg')
	# text = predict_text_by_img(img2,'./pths/model_best.pth.tar')
	# print(text)
